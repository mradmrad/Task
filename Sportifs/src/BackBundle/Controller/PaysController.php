...
class PaysController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pays = $em->getRepository('BackBundle:Pays')->findAll();

        return $this->render('BackBundle:pays:index.html.twig', array(
            'pays' => $pays,
        ));
    }
    ...
    {
        $pay = new Pays();
        $form = $this->createForm('BackBundle\Form\PaysType', $pay);
        ...
        return $this->render('BackBundle:pays:new.html.twig', array(
            'pay' => $pay,
    ...
    public function showAction(Pays $pay)
    {
        ...
        return $this->render('BackBundle:pays:show.html.twig', array(
            'pay' => $pay,
    ...
    {
        $deleteForm = $this->createDeleteForm($pay);
        $editForm = $this->createForm('BackBundle\Form\PaysType', $pay);
        ...
        return $this->render('BackBundle:pays:edit.html.twig', array(
            'pay' => $pay,
